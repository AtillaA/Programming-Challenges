...
Implement a function getNumTransactions(). It takes a username and it returns either the number of transactions associated with username, or a string "Username Not Found" if no such user exists. Make a GET request to the given REST APIs that
