...
----------------------
The REST API contains information about football matches. The provided API allows querying matches by teams and year.
...
https://jsonmock.com/api/football_matches?year=<year>&team1=<team>&page=<page>
https://jsonmock.com/api/football_matches?year=<year>&team2=<team>&page=<page>
...
For example, a GET request to: https://jsonmock.com/api/football_matches?year=2011&team1=Barcelona&page=2
...
Similarly, a GET request to: https://jsonmock.com/api/football_matches?year=2011&team2=Barcelona&page=1
...
Each match record has several fields, but only the following 4 are relevant:
  ...
  • teamlgoals: a string denoting the number of goals scored by team1 in the match.
  • team2goals: a string denoting the number of goals scored by team2 in the match.


Input Format For Custom Testing
-------------------------------
In the first line, there is a string, team. In the second line, there is an integer, year.
...
Explanation: The team is Barcelona and the year is 2011. When we fetch all the matches that Barcelona played in the year 2011, we find that they scored a total of 35 goals, which is the required answer.


Function Description
--------------------
Complete the function getTotalGoals, which has the following parameters:
