Football Competition Winner's Goals
-----------------------------------
The REST API contains information about football competitions and matches. The provided API allows querying competitions by name and year, and it also allows querying matches by competition and year.
The task, for a given competition name and year, is to get the total number of goals scored by the team who won the competition.
...
The item has the following 5 fields:
...
Thus, in order to get all the matches a particular team played in, you need to retrieve matches where the team was the home team and the visiting team.

For example, a GET request to: https://jsonmock.com/api/football_matches?competition=UEFA%20Champions%20League&year=2011&team1=Barcelona&page=2
...
Similarly, a GET request to: https://jsonmock.com/api/football_matches?competition=UEFA%20Champions%20League&year=2011&team2=Barcelona&page=1
...
The response to such a request is a JSON with the following 5 fields:
  ...
  • per_page: The maximum number of matches returned per page. total: The total number of matches on all pages of the results.
...
-------------------------------
In the first line, there is a string, competition. In the second line, there is an integer, year.
...
--------------------
Complete the function getWinnerTotal Goals, which has the following parameters:
